...
8. **(ADDED 2026-06-19, R9)** 講故事從一次性整篇升級為**互動進化的故事接龍**（intent=continue_story）：家教只開個頭就停在鉤子並邀小朋友接；小朋友自己想下一句劇情，家教欣然接受並順著加一句再交回；來回數輪由小朋友共同發展劇情，說「結束」即溫暖收尾。接龍每回合都配圖（成長繪本）。互動風格＝真·一句接一句（DD-21）；連續性靠送模型的歷史回填故事本體（DD-22）。
